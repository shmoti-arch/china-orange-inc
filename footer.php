<footer class="bg-dark text-white py-5 mt-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mb-4">
                ...
                <p class="text-white-50">
                    Premium Chinese oranges delivered fresh to your doorstep. 
            ...
            <div class="col-lg-3 mb-4">
                ...
                <ul class="list-unstyled text-white-50">
                    <li><i class="fas fa-envelope me-2"></i>info@chinaorange.com</li>
                    <li><i class="fas fa-phone me-2"></i>+1 (555) 123-4567</li>
                    <li><i class="fas fa-map-marker-alt me-2"></i>123 Orange St, Fruit City</li>
                </ul>
            </div>
        </div>
        <hr class="my-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                <p class="mb-0 text-white-50">&copy; 2024 China Orange Inc. All rights reserved.</p>
            </div>
